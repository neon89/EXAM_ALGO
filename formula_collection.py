# applies Bid Ask structure on Oanda.stream_data()
#import tpqoa
#class myOanda(tpqoa.tpqoa):
#    def on_success(self, time, bid, ask):
#        ''' Method called when new data is retrieved. '''
#        #my_oanda = myOanda('pyalgo.cfg')
...
# MOdel import 
# FInance Book AI hilb 211 / CHECKE die Test Prüfung CNN, RNN, müssen 3D Daten sein !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!im fitting process 
